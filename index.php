    ...
    <div class="row" id="hero">
        ...
        <div class="name show-for-medium-up">
            <div class="medium-6 large-6 columns">
                <img src="images/AuTX%20logo.gif"/ >
            </div>
        </div>
                ...
                <div class="small-12 medium-12 large-12 columns">
                    <div class="panel">
                        ...
                        <h4>1. Select Location *</h4>
                        	...
                        	<div class="show-for-small-only" style="font-size: 12px;">Use this button to report a bird <strong>in your current location</strong> - to log a different location or see a map, <a href="http://d-bird.org/tx/mobile.php"><strong>click here</strong></a></div>
    ...
    <script>
        ...
        var geosearchControl;
            ...
            $(document).ready(function () {
                ...
                map = L.map('map', {scrollWheelZoom: false}).setView([31.364162, -99.018081], 6);
